...
SERVICE_ACCOUNT_FILE = '/Users/cemiledemir/Downloads/upschool-article-scraper-16d4dc8cfb44.json'
...
try:
    ...
    email_addresses = ['cemiledmr8@gmail.com']  # Add your desired email addresses here
    share_sheet(drive_service, spreadsheet_id, email_addresses)

    # Prepare data for Google Sheets
    sheet_data = [['Title', 'Link']]  # Header row

    for page in range(1, 6):  # Loop through
